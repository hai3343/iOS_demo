...
@interface LGPhotoPickerBrowserViewController () <UIScrollViewDelegate,LGPhotoPickerPhotoScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIActionSheetDelegate,LGPhotoPickerCustomToolBarViewDelegate>
...
- (void)longPressAction {
    NSLog(@"long pressed");
    UIActionSheet *action = [[UIActionSheet alloc] initWithTitle:@"保存相片到本地" delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:@"保存" otherButtonTitles:nil, nil];
