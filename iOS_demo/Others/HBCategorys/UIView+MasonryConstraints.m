...
@implementation UIView (MasonryConstraints)
               ...
               constraintValue:(HKConstraints)constraintsValue
{
    switch (type)
    {
        case TopLeftWidthHeight:  //设置约束类型为 上左宽高
        {
            ...
            break;
        case TopLeftBottomRight:  //设置约束类型为 上左下右
        {
            [self mas_makeConstraints:^(MASConstraintMaker *make) {
                make.top.mas_equalTo(constraintsValue.f_value1);
                make.left.mas_equalTo(constraintsValue.f_value2);
            ...
            break;
        case TopLeftRightHeight:  //设置约束类型为 上左右高
        {
            [self mas_makeConstraints:^(MASConstraintMaker *make) {
                make.top.mas_equalTo(constraintsValue.f_value1);
                make.left.mas_equalTo(constraintsValue.f_value2);
            ...
            break;
        case TopRightWidthHeight:  //设置约束类型为 上右宽高
        {
            [self mas_makeConstraints:^(MASConstraintMaker *make) {
                make.top.mas_equalTo(constraintsValue.f_value1);
            ...
            break;
        case WidthHeightCenter:  //设置约束类型为 宽高居中
        {
            [self mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            break;
        case LeftBottomRightHeight:  //设置约束类型为 左下右高
        {
            [self mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            break;
        case TopWidthHeightCenterX:  //设置约束为 上宽高中心x
        {
            [self mas_makeConstraints:^(MASConstraintMaker *make) {
                make.top.mas_equalTo(constraintsValue.f_value1);
            ...
            break;
        case LeftWidthHeightCenterY:  //设置约束为 左宽高中心y
        {
            [self mas_makeConstraints:^(MASConstraintMaker *make) {
                make.left.mas_equalTo(constraintsValue.f_value1);
                make.width.mas_equalTo(constraintsValue.f_value2);
