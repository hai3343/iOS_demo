...
/*
 ...
 [lblInfo1 setConstraintsWithType:WidthHeightCenter constraintValue:(HKConstraints){80, 30, 0, 0}];
 ...
 [lblInfo2 setConstraintsWithType:TopLeftWidthHeight constraintValue:(HKConstraints){0, 0, 0, 0} constraintsArray:@[lblInfo1.mas_bottom,lblInfo1.mas_left, lblInfo1.mas_width, lblInfo1.mas_height]];
...
{
    TopLeftWidthHeight      = 1,      //<!设置约束为 上左宽高
    WidthHeightCenter       = 2,      //!<设置约束为 宽高中心
    TopRightWidthHeight     = 3,      //!<设置约束为 上右宽高
    TopLeftBottomRight      = 4,      //!<设置约束为 上左下右
    TopLeftRightHeight      = 5,      //!<设置约束为 上左右高
    LeftBottomRightHeight   = 6,      //!<设置约束为 左下右高
    TopWidthHeightCenterX   = 7,      //!<设置约束为 上宽高中心x
    LeftWidthHeightCenterY  = 8       //!<设置约束为 左宽高中心y
};//!<约束类型

@interface UIView ( MasonryConstraints)
